...
- GitHub contains Overview, Statistics, Activity history, Work, and Repositories. Repositories manages imports and stored coverage. Its existing URL remains `/github?view=projects`.
